...
import { ArrowLeft, Send, ShieldAlert, CheckCircle2, XCircle } from "lucide-react";
...
export default function DisputeDetailsPage({ params }: { params: { id: string } }) {
  ...
  const sendMutation = useMutation({
    ...
    onError: (e: any) => {
      toast({ title: t("toast.error") || "Error", description: e?.message || "Failed to send", variant: "destructive" });
    },
  });
            ...
            <AlertDialog>
              <AlertDialogTrigger asChild>
                <Button
                  ...
                  disabled={!dispute || ["resolved","cancelled"].includes(dispute.status) || resolveMutation.isPending}
                >
              ...
              <AlertDialogContent>
                <AlertDialogHeader>
                  ...
                  <AlertDialogDescription>
                    This will mark the dispute as <b>resolved</b>. You can’t undo this action.
                  </AlertDialogDescription>
                </AlertDialogHeader>
                <AlertDialogFooter>
            ...
            <AlertDialog>
              <AlertDialogTrigger asChild>
                <Button
                  ...
                  variant="secondary"
                  className="gap-2"
                  disabled={!dispute || ["resolved","cancelled"].includes(dispute.status) || cancelMutation.isPending}
                >
              ...
              <AlertDialogContent>
                <AlertDialogHeader>
                  ...
                  <AlertDialogDescription>
                    This will mark the dispute as <b>cancelled</b>. You can’t undo this action.
                  </AlertDialogDescription>
                </AlertDialogHeader>
                <AlertDialogFooter>
            ...
            {dLoading ? (
              ...
              <div className="grid grid-cols-2 gap-3">
                <div>
                  ...
                  <div className="font-medium">{dispute.listingTitle || "—"}</div>
                </div>
                <div>
                ...
                <div>
                  ...
                  <div className="font-medium">@{dispute.buyer?.username || "—"}</div>
                </div>
                <div>
                  <div className="text-muted-foreground">Seller</div>
                  <div className="font-medium">@{dispute.seller?.username || "—"}</div>
                </div>
                <div>
                ...
                <div>
                  ...
                  <div className="font-medium">
                    {dispute.lastUpdateAt ? new Date(dispute.lastUpdateAt).toLocaleString() : "—"}
                  </div>
                </div>
              </div>
            )}
