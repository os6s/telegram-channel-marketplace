...
export default function Marketplace() {
  ...
  // Local + server merge
  const [localListings, setLocalListings] = useState<AnyListing[]>(() =>
    listLocalListings()
  );
  useEffect(() => {
  ...
  // Client-side filtering (aligned with schema)
  ...
  const usernamePlatforms: Platform[] = [
    "telegram",
    "twitter",
    "instagram",
    "discord",
  ...
  const accountPlatforms: Platform[] = [
    "telegram",
    "twitter",
    "instagram",
    "discord",
