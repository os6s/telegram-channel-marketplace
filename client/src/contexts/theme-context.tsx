...
export function ThemeProvider({ children }: { children: ReactNode }) {
  ...
  const resolved = useMemo<Resolved>(() => (theme === "system" ? systemResolved() : theme), [theme]);
  ...
  // react to system only when theme === "system"
  useEffect(() => {
  ...
  // react to Telegram theme only when theme === "system"
  useEffect(() => {
    const tg = (window as any)?.Telegram?.WebApp;
